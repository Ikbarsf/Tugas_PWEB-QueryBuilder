...
<div class="toolbar" id="kt_toolbar">
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <h1 class="d-flex text-dark fw-bolder fs-5 align-items-center my-1"><span class="text-muted fw-normal">Beranda - E-Commerce - </span>&nbsp;Tambah Data Produk</h1>
        </div>
    ...
    <div id="kt_content_container" class="container-xxl">
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details">
                <form id="kt_account_profile_details_form" class="form" method="POST" action="{{url('/admin/product/store-product')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body border-top p-9">
                        <div class="row mb-6">
                            <label class="col-lg-4 col-form-label required fw-bold fs-6">Nama Produk</label>
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="product_name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 @error('product_name') is-invalid @enderror" placeholder="Nama Produk" />
                                @error('product_name')
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="number" id="currency" name="price" min="0" class="harga form-control form-control-lg form-control-solid mb-3 mb-lg-0 @error('price') is-invalid @enderror" placeholder="Harga Produk" />
                                @error('price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>&nbsp; &nbsp; &nbsp;{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="number" name="quantity" min="0" class="harga form-control form-control-lg form-control-solid mb-3 mb-lg-0 @error('quantity') is-invalid @enderror" placeholder="Stok Produk" />
                                @error('quantity')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>&nbsp; &nbsp; &nbsp;{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="date" name="expired_date" min="0" class="harga form-control form-control-lg form-control-solid mb-3 mb-lg-0 @error('expired_date') is-invalid @enderror" placeholder="Stok Produk" />
                                @error('expired_date')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>&nbsp; &nbsp; &nbsp;{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <textarea name="description" class="harga form-control form-control-lg form-control-solid mb-3 mb-lg-0 @error('description') is-invalid @enderror" placeholder="Deskrispsi"></textarea>
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>&nbsp; &nbsp; &nbsp;{{ $message }}</strong>
                                    </span>
